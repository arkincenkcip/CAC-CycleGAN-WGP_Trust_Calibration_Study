...
#MODEL_PATH = OUT_DIR/'model_acc_100.00_epoch_360.pth'
...
class ModelTester:
    ...
    def __init__(self, model_path, data_path, device='cuda', excluded_fault_label=None): #SET EXCLUDED LABEL HERE!!!
    ...
    def load_data(self, data_path):
        ...
        for i in labels:
            self.domain_B_train_X_by_class[i] = data[f'domain_B_train_X_{i}'][:5]
            self.domain_B_train_Y_by_class[i] = data[f'domain_B_train_Y_{i}'][:5]
